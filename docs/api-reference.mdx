...
// import from '@adonis-agora/collaboration-client/automerge'
...
class DocSession {
  ...
  pause(): void          // stop() + refuse every reconnect (start/retain/subscribe/timer)
  resume(): Promise<void> // clear the latch; reconnects only if a consumer is mounted
