---
title: Commands
description: collaboration:init, collaboration:prune and make:collab-document — what each one writes, every flag, and the generated document-types file explained line by line.
icon: SquareTerminal
---
...
Applies a retention policy to the version history: keeps the most recent versions of each document
and deletes the rest. Nothing runs it for you — put it in cron, a scheduler task, or a deploy hook.
