...
Deleting a version is not part of the manager API. If a retention policy matters to you, prune
`collab_versions` directly and treat the storage interface as the contract you are honouring.
